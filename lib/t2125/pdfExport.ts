...
export function convertToT2125PDFData(data: T2125Data): T2125PDFData {
  const totalVehicleExpenses =
    data.motorVehicle.fuelOil +
    data.motorVehicle.insurance +
    data.motorVehicle.licence +
    data.motorVehicle.maintenance;

  const businessUsePercent = data.motorVehicle.businessUsePercent;
  ...
  return {
    ...
    part3_income: {
      line3A_gross_sales_incl_gst: data.income.line8000_grossIncome,
      line3B_gst_collected: 0,
      line3C_subtotal: data.income.line8000_grossIncome,
      line8000_adjusted_gross_sales: data.income.line8000_grossIncome,
      line8230_other_income: 0,
      line8299_total_gross_income: data.income.line8299_grossBusinessIncome,
    },
    part4_expenses: {
      line8521_advertising: data.expenses.line8521_advertising,
      line8523_meals_entertainment: data.expenses.line8523_mealsEntertainment,
      line8590_bad_debts: data.expenses.line8590_badDebts,
      line8690_insurance: data.expenses.line8690_insurance,
      line8710_interest_bank_charges: data.expenses.line8710_interestBankCharges,
      line8760_business_taxes_licences: data.expenses.line8760_businessTaxesLicences,
      line8810_office_expenses: data.expenses.line8810_officeExpenses,
      line8811_office_supplies: data.expenses.line8811_officeStationery,
      line8860_professional_fees: data.expenses.line8860_professionalFees,
      line8871_management_fees: data.expenses.line8871_managementFees,
      line8910_rent: data.expenses.line8910_rent,
      line8960_repairs_maintenance: data.expenses.line8960_repairsMaintenance,
      line9060_salaries_wages: data.expenses.line9060_salariesWages,
      line9180_property_taxes: data.expenses.line9180_propertyTaxes,
      line9200_travel: data.expenses.line9200_travelExpenses,
      line9225_telephone_utilities: data.expenses.line9225_telephone,
      line9220_utilities: data.expenses.line9220_utilities,
      line9224_fuel_costs: data.expenses.line9224_fuelCosts,
      line9270_other_expenses: data.expenses.line9270_other,
      line9275_delivery_freight: data.expenses.line9275_deliveryFreight,
      line9281_motor_vehicle: data.expenses.line9281_motorVehicleExpenses,
      line9936_cca: data.expenses.line9936_cca,
      line9945_home_office: data.expenses.line9945_homeOffice,
      line9368_total_expenses: data.expenses.line9368_totalExpenses,
      line9369_net_income: data.netIncome.line9369_netIncomeBeforeAdjustments,
    },
    chartA_vehicle: {
      line1_business_km: data.motorVehicle.businessKm,
      line2_total_km: data.motorVehicle.totalKm,
      line3_fuel_oil: data.motorVehicle.fuelOil,
      line4_interest: 0,
      line5_insurance: data.motorVehicle.insurance,
      line6_licence_registration: data.motorVehicle.licence,
      line7_maintenance_repairs: data.motorVehicle.maintenance,
      line8_leasing: 0,
      line9_electricity: data.motorVehicle.electricity,
      line10_other: 0,
      ...
      line16_allowable_expenses: data.motorVehicle.businessPortion,
    },
    summary: {
      gross_income: data.income.line8299_grossBusinessIncome,
      total_expenses: data.expenses.line9368_totalExpenses,
      net_income: data.netIncome.line9946_yourNetIncome,
